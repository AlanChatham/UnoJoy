...
typedef struct {
	...
	uint8_t r1_btn : 1;
	uint8_t l2_btn : 1;
	uint8_t r2_btn : 1;   //End first button byte
	uint8_t select_btn : 1; // Start second button byte
	uint8_t start_btn : 1;
	uint8_t l3_btn : 1;
	uint8_t r3_btn : 1;
	uint8_t ps_btn : 1;
	uint8_t : 3; //padding to finish off second button byte
...
//	void sendReport(JoystickReport* keys);
public:
	Joystick_(void);
	void begin(void);
	void end(void);
