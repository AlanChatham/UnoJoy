...
int stickDiameter = PApplet.parseInt( 0.134f * imageWidth );

// Indicator positions
Point leftStickPos = new Point( 0.351f*imageWidth + offset.x, 0.581f*imageWidth + offset.y );
Point rightStickPos = new Point( 0.642f*imageWidth + offset.x, 0.581f*imageWidth + offset.y );

Point trianglePos = new Point( 0.795f*imageWidth + offset.x, 0.357f*imageWidth + offset.y );
Point circlePos = new Point( 0.868f*imageWidth + offset.x, 0.430f*imageWidth + offset.y );
Point squarePos = new Point( 0.721f*imageWidth + offset.x, 0.430f*imageWidth + offset.y );
Point crossPos = new Point( 0.795f*imageWidth + offset.x, 0.504f*imageWidth + offset.y );

Point l1Pos = new Point( 0.201f*imageWidth + offset.x, 0.068f*imageWidth + offset.y );
Point l2Pos = new Point( 0.201f*imageWidth + offset.x, 0.156f*imageWidth + offset.y );
Point l3Pos = new Point( leftStickPos.x,leftStickPos.y );

Point r1Pos = new Point( 0.795f*imageWidth + offset.x, 0.068f*imageWidth + offset.y );
Point r2Pos = new Point( 0.795f*imageWidth + offset.x, 0.156f*imageWidth + offset.y );
Point r3Pos = new Point( rightStickPos.x,rightStickPos.y );

Point selectPos = new Point( 0.405f*imageWidth + offset.x, 0.446f*imageWidth + offset.y );
Point startPos = new Point( 0.583f*imageWidth + offset.x, 0.446f*imageWidth + offset.y );
Point homePos = new Point( 0.502f*imageWidth + offset.x, 0.518f*imageWidth + offset.y );

Point dpadLeftPos = new Point( 0.130f*imageWidth + offset.x, 0.426f*imageWidth + offset.y );
Point dpadUpPos = new Point( 0.200f*imageWidth + offset.x, 0.357f*imageWidth + offset.y );
Point dpadRightPos = new Point( 0.270f*imageWidth + offset.x, 0.427f*imageWidth + offset.y );
Point dpadDownPos = new Point( 0.200f*imageWidth + offset.x, 0.500f*imageWidth + offset.y );
...
//
  ...
  ellipse( leftStickPos.x + stickDiameter * (leftStickData.x-128)/255, 
           leftStickPos.y + stickDiameter * (leftStickData.y-128)/255, 
           stickIndicatorSize/1.5f, stickIndicatorSize/1.5f );
...
public int readSerialPort(int timeout, int defaultValue){
